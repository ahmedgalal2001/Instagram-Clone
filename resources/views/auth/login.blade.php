...
@section('body')
    ...
    <div class="col-12 d-flex justify-content-center align-items-center " id="login">
        <div class="col-6 img-fluid text-center">
            <img class="img-fluid"src={{ asset('images/login.png') }} alt="LoginPage">
        </div>
        <div class="col-4 ">
            <div class="border p-5">
                ...
                <form method="POST" action="{{ route('login') }}">
                    @csrf
                    <div class="mb-1 ">
                        <input type="email" name="email" class="w-100 formborder form-control" id="exampleInputEmail1"
                            aria-describedby="emailHelp" placeholder="Phone number,username, or email">
                    </div>
                    <div class="mb-3 ">
                        <input type="password" name="password" class="w-100 form-control" id="exampleInputPassword1"
                    ...
                    <div>
                        <hr
                            style='border: none; border-bottom: 1px solid black; width: 40%; display: inline-block; margin: 0 10px;'>
                        OR
                        <hr
                            style='border: none; border-bottom: 1px solid black; width: 40%; display: inline-block; margin: 0 10px;'>
                    </div>

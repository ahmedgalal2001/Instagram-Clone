...
<div class="col-12 d-flex justify-content-center align-items-center " id="login">
    ...
    <div class="col-4 ">
        ...
        <form method="POST" action="{{ route('login') }}">
            @csrf
            <div class="mb-1 ">
                <input type="email" name="email" class="w-100 formborder form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Phone number,username, or email">
            </div>
            <div class="mb-3 ">
                <input type="password" name="password" class="w-100 form-control" id="exampleInputPassword1" placeholder="password">
            </div>
            <div class=" mb-3">
                <button type="submit" class="btn lightblue w-100 text-light">Login</button>
            </div>
            <div>
                <hr style='border: none; border-bottom: 1px solid black; width: 40%; display: inline-block; margin: 0 10px;'>
                OR
                <hr style='border: none; border-bottom: 1px solid black; width: 40%; display: inline-block; margin: 0 10px;'>
            </div>
        ...
        <div class="border mt-3 w-100 p-3 text-center">
            <p>Donot have an account? <a href="">Sign up</a></p>
        </div>

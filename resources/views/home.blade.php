...
@section('body')
        ...
        <div class="cover">
            ...
            <div class="scroll-images d-flex align-items-start">
                <div class="d-flex flex-column align-items-center m-2">
                    <a type="button">
                        <img src="https://cdn-icons-png.flaticon.com/128/15375/15375366.png" class="rounded-circle avatar"
                            width="65px" height="65px" alt="Avatar" />
                    </a>
                    <p>mohamed</p>
                </div>
                <div class="d-flex flex-column align-items-center m-2">
                    <a type="button">
                        <img src="{{ asset('images/dog.jpg') }}" class="rounded-circle avatar" width="65px" height="65px"
                            alt="Avatar" />
                    </a>
                    <p>mohamed</p>
                </div>
                        ...
                        <div class="col-3 d-flex pt-3 justify-content-center align-items-center">
                            <div class="avatar-container position-relative mb-2">
                                <img src="https://cdn-icons-png.flaticon.com/128/15375/15375366.png"
                                    class="rounded-circle avatar" width="65px" height="65px" alt="Avatar" />
        ...
        <div class="card mb-3 ">
            <div class="row g-0">
                <div class="col-md-4 d-flex">
                    <a href="#"><img class="img-fluid rounded-circle test"
                            src="https://cdn-icons-png.flaticon.com/128/15375/15375366.png" alt="dog"></a>
                </div>
                <div class="col-md-8 ">
                ...
                <div class="row g-0">
                    <div class="col-md-4 w-100 d-flex">
                        <div class="avatar-container d-flex">
                            <a href="#"><img class="img-fluid rounded-circle test"
                                    src="https://cdn-icons-png.flaticon.com/128/15375/15375366.png" alt="ahmed"
                                    id="avatar-image"></a>
                            <div class="popup " id="popup">
                                <div class="d-flex align-items-center">
                                    <a href="#"><img class="img-fluid mr-3 test"
                                            src="https://cdn-icons-png.flaticon.com/128/15375/15375366.png"
                                            alt="dog"></a>
                                    <div>
                                        <h6 class="card-title mb-0">Ahmed Kamal</h6>
                                        <p>ahmed_kamal71</p>
    ...
    <!------------------------- Comments Modal -------------------------->
    <div class="modal fade bg-none" id="commentsModal" tabindex="-1" role="dialog" aria-labelledby="commentsModal"
        aria-hidden="true">

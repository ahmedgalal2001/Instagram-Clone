    ...
    <div class="col-10">
        ...
        <div class="col-md-9">
            <div class="d-flex align-items-start col-12">
                <div class="nav flex-column nav-pills me-5 col-3" id="v-pills-tab" role="tablist"
                    ...
                    <button class="nav-link text-start" id="v-pills-profile-tab " data-bs-toggle="pill"
                        ...
                        aria-controls="v-pills-profile" aria-selected="false"><i class="fa-solid fa-ban me-2"></i>
                        Blocked</button>
                </div>
...
<!-- Modal -->
<div class="modal fade " id="staticBackdropghrabawy" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">

    ...
    <main class="container"> --}}
      ...
      <section id="header" class="row">
        <section class="col-md-4 col-3 text-center">
          <img src="{{ asset('images/profile.jpeg') }}" class="rounded-circle img-fluid w-50" alt="img"
            width="200px" />
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content bg-dark text-light">
          ...
          <ul class=" modal-body list-group border-0 mt-3">
              ...
              <li class="list-group-item border-0 d-flex justify-content-between align-items-center bg-dark text-light">
                <div class="d-flex justify-content-start align-items-center gap-1">
                  <img src="{{ asset('images/bussiness-man.png') }}" class="rounded-circle img-fluid" alt="img" width="50px" />
                  <div class="d-flex flex-column">
                    <p class="fs-5 mt-3 mx-1">mohamedtorkey20 </p>
                    <p class="text-secondary" style="font-size:15px; font-weight: bold; margin-top:-19px;">mohamed torkey
                    </p>
                  </div>
                </div>
                <div>
              ...
              </li><li class="list-group-item border-0 d-flex justify-content-between align-items-center bg-dark text-light">
                <div class="d-flex justify-content-start align-items-center gap-1">
                  <img src="{{ asset('images/bussiness-man.png') }}" class="rounded-circle img-fluid" alt="img" width="50px" />
                  <div class="d-flex flex-column">
                    <p class="fs-5 mt-3 mx-1">mohamedtorkey20 </p>
        ...
        <div class="modal-content bg-dark">
          ...
          <div class="mt-3 bg-dark text-light">
            ...
            <ul id="bodyHashtags" class="list-group border-0 mt-3 d-none ">
              ...
              <li class="d-flex justify-content-center align-items-center flex-column  fs-1 mb-3 bg-dark text-light">
                #
